...

{
  ...
  networking.extraHosts = ''
    127.0.0.1 mesos-master-slave-01 mesos-slave-01.vagrant
  '';
  ...
  services.clusterMS = {
    ...
    tinc_core_node01_fqdn = "192.168.56.201";
    ...
    tinc_core_node02_fqdn = "192.168.56.202";
    ...
    tinc_core_node02_public_key = ''
      ...
      -----END RSA PUBLIC KEY-----
    '';
    tinc_core_node03_fqdn = "192.168.56.202";
    tinc_core_node03_ip_address = "10.254.0.2";
